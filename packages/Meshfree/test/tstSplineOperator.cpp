...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( SplineOperator,
                                   ...
                                   RadialBasisFunction, PolynomialBasis )
{
    ...
    DataTransferKit::SplineOperator<DeviceType, RadialBasisFunction,
                                                PolynomialBasis>
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( SplineOperator, grid, DeviceType,
                                   RadialBasisFunction, PolynomialBasis )
{
    using namespace DataTransferKit;
...
TEUCHOS_UNIT_TEST_TEMPLATE_3_DECL( SplineOperator, line, DeviceType,
                                   RadialBasisFunction, PolynomialBasis )
{
    using namespace DataTransferKit;
...
#define UNIT_TEST_GROUP( NODE )                                                \
    ...
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(                                      \
        SplineOperator, same_npoints_and_basis, DeviceType##NODE,  \
        Wendland0, Constant3 )                                                 \
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(                                      \
        SplineOperator, same_npoints_and_basis, DeviceType##NODE,  \
        Wendland0, Linear3 )                                                   \
    ...
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( SplineOperator, line,    \
    ...
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( SplineOperator, line,    \
                                          DeviceType##NODE, Wendland0,         \
                                          Quadratic3 )                         \
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( SplineOperator, grid,    \
                                          DeviceType##NODE, Wendland0,         \
                                          Constant3 )                          \
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( SplineOperator, grid,    \
                                          DeviceType##NODE, Wendland0,         \
    ...
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT( SplineOperator, grid,    \
                                          ...
                                          Quadratic3 )                         \
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(                                      \
        SplineOperator, single_point_in_radius, DeviceType##NODE,  \
        Wendland0, Constant3 )                                                 \
    TEUCHOS_UNIT_TEST_TEMPLATE_3_INSTANT(                                      \
        SplineOperator, single_point_in_radius, DeviceType##NODE,  \
        Wendland0, Linear3 )                                                   \
